...
def background_scheduler(interval_hours):
    """Fonction exécutée en arrière‑plan pour lancer le pipeline toutes les X heures."""
    while True:
        run_pipeline()
...
def run_pipeline():
    ...
    update_pipeline_status("running", "Pipeline en cours...")
